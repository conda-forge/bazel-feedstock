...
set "EXTRA_BAZEL_ARGS=--tool_java_runtime_version=remotejdk_21 --java_runtime_version=remotejdk_21 --local_resources=cpu=1 --subcommands --verbose_failures --logging=6"
